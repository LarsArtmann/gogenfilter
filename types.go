...
// allSpecificOptions returns all tool-specific filter options (excluding FilterAll and FilterGeneric).
// FilterGeneric is handled separately as a fallback after specific checks.
