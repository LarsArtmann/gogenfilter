...
func TestHasSQLCContent(t *testing.T) {
	t.Parallel()
	...
	runBoolTableTest(t, []struct {
	...
	}{
		{
			...
			input:    "// Code generated by sqlc. DO NOT EDIT.\npackage db\n",
			expected: true,
		},
		{
			name:     "sqlc versions block",
			input:    "// Code generated by sqlc v1.25.0\n// versions:\npackage db\n",
			expected: true,
		},
		{
			name:     "code pattern only",
			input:    "package db\nid := sqlc.Arg(\"id\")\n",
			expected: true,
		},
		{
			name:     "no sqlc markers",
			input:    "package main\nfunc main() {}\n",
			expected: false,
		},
...
func TestDetectReason(t *testing.T) {
	...
	t.Run("detects generated file from disk", func(t *testing.T) {
		...
		reason := detectReason(tmpFile, map[FilterOption]bool{FilterSQLC: true})
	...
	t.Run("returns not filtered for non-existent file", func(t *testing.T) {
		...
		reason := detectReason("/nonexistent/file.go", map[FilterOption]bool{FilterSQLC: true})
	...
	t.Run("returns not filtered when no options enabled", func(t *testing.T) {
		...
		reason := detectReason(tmpFile, map[FilterOption]bool{})
		if reason != ReasonNotFiltered {
			t.Errorf("Expected %v, got %v", ReasonNotFiltered, reason)
		}
	})
