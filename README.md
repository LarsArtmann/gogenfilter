...
<p align="center">
<a href="https://pkg.go.dev/github.com/LarsArtmann/gogenfilter/v3"><img src="https://pkg.go.dev/badge/github.com/LarsArtmann/gogenfilter/v3.svg" alt="Go Reference"></a>
...
<p align="center">
<a href="https://gogenfilter.lars.software">Documentation</a> · <a href="https://pkg.go.dev/github.com/LarsArtmann/gogenfilter/v3">API Reference</a>
</p>
...
| Tool                                                           | Detection                                        |
| -------------------------------------------------------------- | ------------------------------------------------ |
| [sqlc](https://sqlc.dev)                                       | `*.sql.go` suffix + content                      |
...
This library is at **v3** and follows [Go module versioning](https://go.dev/doc/modules/version-numbers). Standard Go compatibility guarantees apply — no breaking changes without a major version bump. The core `Filter` / `DetectReason` API is stable.
