...
var _ = ginkgo.Describe("gogenfilter", func() {
	...
	ginkgo.Describe("Filter creation", func() {
		...
		ginkgo.When("created with FilterAll", func() {
			...
			ginkgo.It("filters generated files", func() {
				filtered, err := filter.Filter("db/query.sql.go")
				gomega.Expect(err).NotTo(gomega.HaveOccurred())
	...
	ginkgo.Describe("Detecting generated code", func() {
		ginkgo.DescribeTable(
			...
			ginkgo.Entry("sqlc", "db/query.sql.go",
			...
			ginkgo.Entry("mockgen _mock.go only (mock_ belongs to mockery)", "mock_service.go",
				"// Code generated by MockGen. DO NOT EDIT.\npackage mocks\n",
				gogenfilter.ReasonMockery),
		...
		ginkgo.DescribeTable(
			...
			ginkgo.Entry(
				"sqlc models.go is NOT phase-1",
				"db/models.go",
				gogenfilter.ReasonNotFiltered,
			),
			ginkgo.Entry(
				"sqlc querier.go is NOT phase-1",
				"db/querier.go",
				gogenfilter.ReasonNotFiltered,
			),
			ginkgo.Entry(
				"sqlc batch.go is NOT phase-1",
				"db/batch.go",
				gogenfilter.ReasonNotFiltered,
			),
			...
			ginkgo.Entry("mockgen _mock.go only", "service_mock.go", gogenfilter.ReasonMockgen),
			ginkgo.Entry("mockery mock_ prefix", "mock_service.go", gogenfilter.ReasonMockery),
			ginkgo.Entry(
		...
		ginkgo.Describe("Include patterns", func() {
			ginkgo.When("a file matches include pattern and is generated", func() {
				ginkgo.It("filters it as generated", func() {
					...
					filter, err := gogenfilter.NewFilter(
						opts,
						gogenfilter.WithIncludePatterns("*.sql.go"),
					)
					gomega.Expect(err).NotTo(gomega.HaveOccurred())
					filtered, err := filter.Filter("query.sql.go")
					gomega.Expect(err).NotTo(gomega.HaveOccurred())
					gomega.Expect(filtered).To(gomega.BeTrue())
				})
			})
