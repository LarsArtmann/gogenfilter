...
| `detection.go` | Core detection logic, `detectors` table (18 entries), `DetectReason`, `DetectReasonReader`, `DetectReasonFile`, filename/content matchers, trace-aware detection functions, `AllFilterOptions()`, `AllGeneratorOptions()`, `AllFilterReasons()`                          |
