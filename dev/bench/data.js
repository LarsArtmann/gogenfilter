    ...
    "gogenfilter": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "fba907af5d569ca5a9774a6710cb2535e782733c",
          "message": "fix(scan): msgp exclusion reason + code quality improvements\n\nBug fix:\n- exclusionsForGenerator default branch now looks up\n  generatorExclusionReasons map before falling back to generic\n  \"auto-generated code\". Previously msgp's specific reason string\n  (\"msgp generated serialization\") was dead code in the map because\n  msgp hit the default switch case with a hardcoded fallback.\n\nTest improvements:\n- Add oapi, deepcopy, wire to generatedTestCases in testdata_test.go\n  (3 detectors were only tested via integration, not per-function unit\n  tests)\n- Add msgp exclusion derivation test verifying the specific reason\n  string is used instead of generic fallback\n\nCode quality:\n- Consolidate matchesAnyContentPattern into anyMatch helper in\n  detection.go — removes duplicate function that was equivalent to\n  anyMatch(content, candidates, strings.Contains)\n- Add doc comments to all exported error struct fields (ProjectRootError,\n  FilterConfigError, SQLCConfigError)\n\n💘 Generated with Crush\n\nAssisted-by: Crush:glm-5.1",
          "timestamp": "2026-06-11T12:52:45+02:00",
          "tree_id": "8cf0f52db2c8b1d599bd3d32810aff25c7545f0a",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/fba907af5d569ca5a9774a6710cb2535e782733c"
        },
        "date": 1781175231970,
        "tool": "go",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "423ac604b2e1d1dbd4a2fa54145d7bbb6d639c96",
          "message": "docs(AGENTS.md): add new design decisions, fix coverage figure\n\n- Add exclusionPatterns var, empty content guard, FilterResult.Is(),\n  String() methods, readFile lint suppression to Design Decisions\n- Fix coverage: 98.3% (was stale at 99.8%)\n- Fix BDD tests reference to include bdd_extended_test.go\n\n💘 Generated with Crush\n\nAssisted-by: Crush:glm-5.1",
          "timestamp": "2026-06-11T13:10:37+02:00",
          "tree_id": "209abf37476975358034308a6610513eeea13d69",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/423ac604b2e1d1dbd4a2fa54145d7bbb6d639c96"
        },
        "date": 1781176399815,
        "tool": "go",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "f50f209f5570ac0ac69d25138fe342016465c522",
          "message": "chore: normalize table alignment in docs, clean up testdata imports, fix errors.go spacing\n\n- FEATURES.md: normalize table column spacing (trailing spaces removed, consistent alignment)\n- ROADMAP.md: fix underscore escaping in deprioritized item text\n- docs/status/: normalize table spacing in three status reports (2026-06-11 entries)\n- errors.go: normalize SQLCConfigError struct field spacing (consecutive alignments cleaned up)\n- scan_test.go: reformat byte slice literal in TestExclusionDerivation for readability\n- testdata/ent/client.go: remove unused imports (context, entgo.io/ent/dialect/sql)\n- testdata/mockery/mock_user_service.go: remove unused testing import\n- testdata/msgp/types_gen.go: add missing msgp import for realistic generated file\n- website/: normalize table alignment in detection.mdx, generators.mdx, filter-options.mdx (trailing space cleanup, consistent column spacing)\n\n💘 Generated with Crush\n\nAssisted-by: Crush:MiniMax-M2.7-highspeed",
          "timestamp": "2026-06-13T00:00:09+02:00",
          "tree_id": "40f1ab648863ea0d7e8b1908ad5b0e987a624e87",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/f50f209f5570ac0ac69d25138fe342016465c522"
        },
        "date": 1781301676251,
        "tool": "go",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "5dda5a81543f3eb135be78fa996f001ab03f2777",
          "message": "test: refactor string literals to constants + scan.go cleanup\n\n- bdd_extended_test.go: replace \"page_templ.go\" with testhelpers.PageTemplGo,\n  \"main.go\" with testhelpers.MainGo, fix map entry alignment\n- bench_test.go: replace \"custom_gen.go\" with customGenGo constant\n- detect_file_test.go: replace inline stringer content with stringerGeneratedContent\n  constant\n- detection_test.go: use stringerGeneratedContent constant, dbModelsGo constant\n- example_test.go: extract exampleMainGo constant, use throughout examples\n- helpers_test.go: add customGenGo and stringerGeneratedContent constants\n- scan.go: convert generatorExclusionReasons global var to generatorExclusionReasons()\n  function (returns local map to avoid package-level mutable state), extract\n  templExclusionPattern and templExclusionReason as package-level constants,\n  update all call sites accordingly\n- scan_test.go: use dbModelsGo, use FilterTempl type conversion instead of string\n  literal, rename loop var tc→testCase, add ByGenerator and Exclusions to\n  ScanResult test case\n- testhelpers/constants.go: add PageTemplGo constant\n- types_test.go: use string(FilterTempl) instead of \"templ\", use dbModelsGo,\n  add missing Trace field to test cases\n\n💘 Generated with Crush\n\nAssisted-by: Crush:MiniMax-M2.7-highspeed",
          "timestamp": "2026-06-14T03:38:23+02:00",
          "tree_id": "cafba86bd8e2217bb51e128a920080a176461ded",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/5dda5a81543f3eb135be78fa996f001ab03f2777"
        },
        "date": 1781401166355,
        "tool": "go",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d04b8c68bcc2e36cbde77a75642f1fff090898e3",
          "message": "feat(nix): integrate md-go-validator via Nix flake + fix doc discrepancies\n\n- Root-level Nix flake with md-go-validator as flake input\n- Apps: test, lint, validate-docs, website-build\n- devShell: Go 1.26, golangci-lint, Node.js, md-go-validator\n- Multi-system: x86_64/aarch64 linux/darwin\n- vendorHash override for aarch64-darwin compatibility\n\n- md-go-validator now sourced from Nix flake input (was: pre-built binary)\n- validate-docs app uses Nix-provided md-go-validator\n- devShell includes md-go-validator\n\n- validate:docs script: \"../md-go-validator-bin\" → \"md-go-validator\"\n  (resolves from PATH via Nix shell)\n\n- Replaced fragile md-go-validator checkout + manual go build with\n  DeterminateSystems/nix-installer-action + \"nix run .#validate-docs\"\n- Removed PRIVATE_REPO_TOKEN dependency\n- Doc validation is now a hard gate (removed continue-on-error)\n- Added flake.nix + flake.lock to path triggers\n\n- errors.mdx: Add <!-- skip-validate --> to bare function signature\n  (FindProjectRoot signature is not compilable Go code)\n- benchmarks.mdx: Updated all numbers from stale AMD Ryzen CI values\n  to verified Apple M2 local results. Updated hardware label.\n- pattern-matching.mdx: Fixed corrupted glob patterns in Pattern Rules\n  section (backslash-escaped wildcards rendered as literal text)\n\n- sqlc.go: FindSQLCConfigs comment said \"3 levels up\" but actual\n  maxProjectRootDepth is 10. Fixed comment to match implementation.",
          "timestamp": "2026-06-14T18:28:53+02:00",
          "tree_id": "63badff783af42a3204c4ddfe5fde3f46c9c3743",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/d04b8c68bcc2e36cbde77a75642f1fff090898e3"
        },
        "date": 1781455203715,
        "tool": "go",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "8001808deea0c212e4556ce7c1ccdb31454ee885",
          "message": "build: bump nixpkgs and Go module dependencies\n\nUpdates the pinned nixpkgs revision in flake.lock to a newer snapshot and\nlifts several indirect Go module dependencies (ginkgo/v2, gomega, pprof,\ngolang.org/x/{mod,net,sync,text,tools}) to their latest patch releases.\n\nThe Go runtime dependency graph has shifted because ginkgo and gomega\npulled in updated toolchain and protobuf-adjacent packages; bumping them\ntogether keeps the lockfile consistent and avoids a mix of old and new\nchecksums for the same module graph.\n\nNo source code changes are required — these are drop-in compatible patch\nand minor releases — and the existing test suite, lint, and benchmark\nworkflows continue to run against the new versions.\n\n- flake.lock: refresh nixpkgs to current unstable commit\n- go.mod / go.sum: update onsi/ginkgo to v2.31.0, onsi/gomega to v1.42.0,\n  and bump golang.org/x transitive deps to their latest available patches\n- no production code or test assertions modified; all changes are within\n  module version metadata\n\n💘 Generated with Crush\n\nAssisted-by: Crush:MiniMax-M3",
          "timestamp": "2026-06-17T03:17:49+02:00",
          "tree_id": "79ca2e9ae23dc5423254aea0cb660ba0ef9b682e",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/8001808deea0c212e4556ce7c1ccdb31454ee885"
        },
        "date": 1781679064674,
        "tool": "go",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "62de20b7a97ef8270c72b52d7e8f9f7c318b80d3",
          "message": "chore: integrate buildflow-managed gitignore section, update Nix flake inputs, add test dependencies, and fix testdata alignment\n\nThis commit captures four distinct maintenance changes:\n\n### buildflow-managed gitignore section\nAdded a buildflow-managed section (marked with >>> and <<< markers) to\n.gitignore that consolidates common patterns for:\n- Secrets and environment: *.pem, *.key\n- Databases: *.db-shm, *.db-wal\n- Operating systems: ._*, Spotlight-V100, .Trashes, ehthumbs.db\n- Go: go.work.sum\n- Nix: result-*, .envrc, .direnv/\n- JavaScript and TypeScript: *.tsbuildinfo, .next/, .nuxt/, .docusaurus/,\n  .eslintcache, .cache/, .parcel-cache/, npm-debug.log*, yarn-debug.log*,\n  yarn-error.log*, .pnpm-debug.log*\n\nThe section uses the buildflow-managed block pattern so it can be\nautomatically regenerated by `buildflow --fix` while allowing manual\nedits within the marked boundaries.\n\n### Nix flake input updates\nUpdated two locked flake inputs:\n- md-go-validator: lastModified 1782527343→1782671996, narHash updated,\n  rev 7537d51a→abcce87f\n- nixpkgs: lastModified 1782467914→1782723713, narHash updated,\n  rev e73de5be→b5aa0fbd\n\nThese updates bring in the latest nixpkgs and md-go-validator revisions.\n\n### Go test dependency additions\nAdded new test dependencies to go.sum for improved testing infrastructure:\n- github.com/gkampitakis/ciinfo v0.3.2\n- github.com/gkampitakis/go-diff v1.3.2\n- github.com/gkampitakis/go-snaps v0.5.15\n- github.com/goccy/go-yaml v1.18.0\n- github.com/joshdk/go-junit v1.0.0\n- github.com/kr/pretty v0.3.1\n- github.com/kr/text v0.2.0\n- github.com/maruel/natural v1.1.1\n- github.com/mfridman/tparse v0.18.0\n- github.com/rogpeppe/go-internal v1.13.1\n- github.com/stretchr/testify v1.11.1\n- github.com/tidwall/gjson v1.18.0\n- github.com/tidwall/match v1.1.1\n- github.com/tidwall/pretty v1.2.1\n- github.com/tidwall/sjson v1.2.5\n- google.golang.org/protobuf v1.36.7\n- gopkg.in/check.v1 (multiple versions)\n- gopkg.in/yaml.v3 v3.0.1\n\nThese support snapshot testing (go-snaps), test output parsing (tparse,\ngo-junit), YAML processing (go-yaml), JSON manipulation (gjson, sjson),\nand assertion utilities (testify, pretty).\n\n### testdata formatting fix\nFixed JSON tag alignment spacing in testdata/handwritten/types.go:\nChanged:\n  ID    int64  `json:\"id\" db:\"id\"`\n  Name  string `json:\"name\" db:\"name\"`\nTo:\n  ID    int64  `json:\"id\"    db:\"id\"`\n  Name  string `json:\"name\"  db:\"name\"`\n\nThis ensures consistent spacing within struct tags for improved readability.\n\n💘 Generated with Crush\n\nAssisted-by: Crush:MiniMax-M2.7-highspeed",
          "timestamp": "2026-07-02T01:48:56+02:00",
          "tree_id": "10ec81e9790fd43d1bf48fab3d2f9c53b35f81f3",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/62de20b7a97ef8270c72b52d7e8f9f7c318b80d3"
        },
        "date": 1782949791538,
        "tool": "go",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "5f16eb09c91a4c4fc68f3f76a8d1b7430fad6ce1",
          "message": "style: fix markdown table alignment in website docs",
          "timestamp": "2026-07-05T18:54:41+02:00",
          "tree_id": "5819df6720e10481d66be3c404e3c72c0af76b36",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/5f16eb09c91a4c4fc68f3f76a8d1b7430fad6ce1"
        },
        "date": 1783270540536,
        "tool": "go",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "990dc2242214b0278575771324a12b201bc1434c",
          "message": "docs: add status report for documentation quality overhaul session",
          "timestamp": "2026-07-05T21:13:28+02:00",
          "tree_id": "a3bc6a82dcba72535b0877ad4688f6e4f71143e7",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/990dc2242214b0278575771324a12b201bc1434c"
        },
        "date": 1783278860724,
        "tool": "go",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "ae61c916c4a106414e8e61e2ec45826478d51f31",
          "message": "build(deps): comprehensive dependency and tooling updates across Go, Nix, and linting infrastructure\n\ngolangci-lint v2 configuration overhaul — adds cyclop complexity checking (max 12), ginkgolinter with forbid-focus-container and forbid-spec-pollution to prevent Ginkgo test anti-patterns, gomoddirectives replace-local enforcement, makezero always requirement, testifylint with go-require disabled and all checks enabled, varnamelen with broad ignore list for common short variable names, path exclusions for all generated code patterns (wire_gen.go, _mock.go, _enum.go, _templ.go, etc.) to suppress linting on auto-generated files, test file exclusions for unused checks, and issues/formatters limits with generated: lax mode to account for non-compliant generated code.\n\nGo tooling: migrate cmd/gendocs from encoding/json to encoding/json/v2 with jsontext.Marshal for deterministic formatted output; update golang.org/x/sys v0.46.0 → v0.47.0.\n\nNix tooling: update go-finding v1.0.0 → v1.2.0 and md-go-validator to latest revision for improved documentation validation.\n\nDocumentation: normalize markdown table alignment across README.md generators table, api/detection.mdx per-generator table, and generators.mdx detection table — consistent left-aligned columns with uniform padding; remove spurious blank lines between gendocs section markers in README.md.\n\n💘 Generated with Crush\n\nAssisted-by: Crush:MiniMax-M2.7-highspeed",
          "timestamp": "2026-07-09T10:17:14+02:00",
          "tree_id": "19f9a516b4db45848c7400aaa498bc66cd837664",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/ae61c916c4a106414e8e61e2ec45826478d51f31"
        },
        "date": 1783585106624,
        "tool": "go",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d711c77bcbb02cc7440bf37ce9506055f45c707c",
          "message": "ci: bump actions/checkout from 6 to 7 (#26)",
          "timestamp": "2026-07-18T20:43:23+02:00",
          "tree_id": "31713939acfb80dacf70e789849a63170b4b84b4",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/d711c77bcbb02cc7440bf37ce9506055f45c707c"
        },
        "date": 1784400292108,
        "tool": "go",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "52981e9b2c527e1c69c985318e53db924fbccaa4",
          "message": "deps(go): bump github.com/onsi/ginkgo/v2 from 2.31.0 to 2.32.0 (#27)\n\nBumps [github.com/onsi/ginkgo/v2](https://github.com/onsi/ginkgo) from 2.31.0 to 2.32.0.\n- [Release notes](https://github.com/onsi/ginkgo/releases)\n- [Changelog](https://github.com/onsi/ginkgo/blob/master/CHANGELOG.md)\n- [Commits](https://github.com/onsi/ginkgo/compare/v2.31.0...v2.32.0)\n\n---\nupdated-dependencies:\n- dependency-name: github.com/onsi/ginkgo/v2\n  dependency-version: 2.32.0\n  dependency-type: direct:production\n  update-type: version-update:semver-minor\n...\n\nSigned-off-by: dependabot[bot] <support@github.com>\nCo-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com>",
          "timestamp": "2026-07-18T20:46:04+02:00",
          "tree_id": "236c10321fb9d82249b68e4c63092b701107faea",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/52981e9b2c527e1c69c985318e53db924fbccaa4"
        },
        "date": 1784400427850,
        "tool": "go",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "4602483ac6a7ea8b4b10a443f0857b1ce4626aa1",
          "message": "fix(ci): align generated docs with gendocs tool output\n\nHand-padded markdown tables created a permanent stale-output mismatch:\nCI runs `go generate ./... && git diff --exit-code`, so committed output\nmust match exactly what the tool emits. Regenerated README tables,\ngenerators.mdx, and detection.mdx from source to restore idempotency.\n\n💘 Generated with Crush\n\nAssisted-by: Crush:glm-5.2",
          "timestamp": "2026-07-20T13:13:59+02:00",
          "tree_id": "1c64dcf5fb2f7296f5a2f7a936681497bed2ec97",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/4602483ac6a7ea8b4b10a443f0857b1ce4626aa1"
        },
        "date": 1784546117244,
        "tool": "go",
        "benches": [
          ...
          },
          {
            "name": "BenchmarkDetectReason/not_filtered",
            "value": 2073,
            "unit": "ns/op\t    1672 B/op\t       6 allocs/op",
            "extra": "572734 times\n4 procs"
          },
          {
            "name": "BenchmarkDetectReason/not_filtered - ns/op",
          ...
          },
          {
            "name": "BenchmarkDetectReasonReader/not_filtered",
            "value": 2398,
            "unit": "ns/op\t    2264 B/op\t      10 allocs/op",
            "extra": "497449 times\n4 procs"
          },
          {
            "name": "BenchmarkDetectReasonReader/not_filtered - ns/op",
          ...
          },
          {
            "name": "BenchmarkDetectReasonFileFS/content_based",
            "value": 3397,
            "unit": "ns/op\t    1928 B/op\t      12 allocs/op",
            "extra": "349722 times\n4 procs"
          },
          {
            "name": "BenchmarkDetectReasonFileFS/content_based - ns/op",
          ...
          },
          {
            "name": "BenchmarkDetectReasonFileFS/not_filtered",
            "value": 2666,
            "unit": "ns/op\t    1800 B/op\t      10 allocs/op",
            "extra": "425197 times\n4 procs"
          },
          {
            "name": "BenchmarkDetectReasonFileFS/not_filtered - ns/op",
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "8f111c35f19204af07a9d938a9840986bae4c68d",
          "message": "chore(release): post-recovery hardening — fix README phantom columns and add regression test\n\nAfter the 2026-07-20 CI and README recovery session restored the broken README,\nthe regenerated tables still rendered with phantom empty columns caused by a\nstray \"||\" in the gendocs markdown emitter. This commit finishes the cleanup so\nthe recovery is truly complete and the same class of bug cannot regress silently.\n\nFixed\n\n- README.md generator and filter-options tables now render with the correct\n  two-column layout. The phantom third column appeared as an empty cell after\n  the right-hand pipe in every data row, producing ragged markdown that\n  rendered incorrectly on pkg.go.dev and the website.\n- website/src/content/docs/api/detection.mdx per-generator function table —\n  same corruption, same fix.\n- website/src/content/docs/generators.mdx detection methods table — fixed an\n  additional inconsistency where the lower half of the table had been\n  re-emitted with collapsed whitespace (e.g. ``_easyjson.go`suffix` instead of\n  `` `_easyjson.go` suffix ``), a side effect of the same formatting bug.\n\nAdded\n\n- readme_test.go — table consistency regression guard. Walks README.md,\n  extracts every markdown table (skipping code fences), and asserts that all\n  rows within a table have matching column counts. Includes a negative test\n  that confirms the test catches the exact \"||\" corruption pattern that caused\n  the original bug, so future regressions will fail loudly instead of silently\n  shipping a broken README.\n- CHANGELOG.md and website/src/content/docs/changelog.mdx entries documenting\n  the README fix, the regression test, and the supporting CI fixes from the\n  recovery session (testdata fixture restore, GOEXPERIMENT for benchmark CI,\n  Firebase deploy env-var pattern).\n\nChanged\n\n- cmd/gendocs/main.go — removed the unused filenameNone constant flagged by\n  static analysis. Dead code, no callers.\n\nThe changes are documentation and tooling only — no public API changes, no\ndetection logic changes, no behavior changes. The new test guards against the\nexact failure mode that motivated it; CI will fail fast if gendocs ever\nre-emits the \"||\" pattern.\n\n💘 Generated with Crush\n\nAssisted-by: Crush:MiniMax-M3",
          "timestamp": "2026-07-20T23:39:23+02:00",
          "tree_id": "074399434d5f5c9cab18112ac80ad7fdeb6521cb",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/8f111c35f19204af07a9d938a9840986bae4c68d"
        },
        "date": 1784583630522,
        "tool": "go",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d7cc0e720003930581b78aeef6e956a31b6900a0",
          "message": "docs(all): comprehensive documentation updates and docs generation improvements\n\n- Update README.md with current project information, features, and usage guidelines\n- Modify cmd/gendocs/main.go to improve documentation generation workflow and output quality\n- Update website/src/content/docs/api/detection.mdx with enhanced API documentation for detection functionality\n- Refresh website/src/content/docs/generators.mdx with updated generator documentation and examples\n- Ensure documentation consistency across all modified files\n- Improve clarity and accuracy of technical documentation for end users\n- Add missing or update outdated documentation sections\n- Enhance code examples in documentation where applicable\n- Better align documentation structure between README and website docs\n- Include any new features or changes in detection and generator documentation",
          "timestamp": "2026-07-23T20:33:28+02:00",
          "tree_id": "33b9c24a6fa8c17bd67d10a804931338905ab783",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/d7cc0e720003930581b78aeef6e956a31b6900a0"
        },
        "date": 1784831704280,
        "tool": "go",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "94d9816334948f0c0d36a5d68d028e523c0187aa",
          "message": "feat(website): add newsletter subscription component and styling\n\n- Implement Newsletter component for email subscription functionality on the website\n- Add global CSS styles for consistent typography and layout across all pages\n- Configure Astro site settings for optimal build and deployment\n- Add responsive styling to newsletter form for mobile and desktop views\n- Include form validation styles and hover states for better UX\n- Set up component structure following Astro best practices\n- Add CSS variables for theming consistency throughout the site",
          "timestamp": "2026-07-25T00:44:03+02:00",
          "tree_id": "d951ff38effad6caaa1b40137224ca67b4f3d563",
          "url": "https://github.com/LarsArtmann/gogenfilter/commit/94d9816334948f0c0d36a5d68d028e523c0187aa"
        },
        "date": 1784934481267,
        "tool": "go",
        "benches": [
