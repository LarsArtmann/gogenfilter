...
const (
	sqlcDBContent = "// Code generated by sqlc. DO NOT EDIT.\npackage db\n"
	exampleMainGo = "main.go"
)
...
func ExampleMatchPattern() {
	...
	fmt.Println(gogenfilter.MatchPattern(exampleMainGo, "**/db/*.go"))
	// Output:
	// true
	// true
	// false
...
func ExampleFilter_Filter_notFiltered() {
	runFilterExample(gogenfilter.FilterSQLC, exampleMainGo, "package main\n")
	// Output: false
}
...
func ExampleFilter_FilterDetailed_notFiltered() {
	...
	result, _ := filter.FilterDetailed(exampleMainGo)
	fmt.Println(result.Filtered)
	fmt.Println(result.Reason)
	// Output:
	// false
...
func ExampleWithExcludePatterns_vendorAndTestdata() {
	...
	dbFiltered, _ := filter.Filter("db/models.go")
	mainFiltered, _ := filter.Filter(exampleMainGo)
...
func ExampleDetectReasonFileFS() {
	...
	reason, _ = gogenfilter.DetectReasonFileFS(mapFS, exampleMainGo, gogenfilter.FilterAll)
	fmt.Println(reason)
	// Output:
	// templ
	// not-filtered
...
func ExampleFilter_FilterWithContent() {
	...
	filtered, _ = filter.FilterWithContent(exampleMainGo, regularContent)
	fmt.Println(filtered)
	// Output:
	// true
	// false
...
func ExampleFilter_FilterDetailedAndContent() {
	mapFS := mapFSWithFile(
		"repository.go",
		"// Code generated by my-tool. DO NOT EDIT.\npackage repo\n",
	)
	filter := newTestFilter(gogenfilter.FilterAll, mapFS)

	result, content, _ := filter.FilterDetailedAndContent("repository.go")
	fmt.Println(result.Filtered)
	fmt.Println(result.Reason)
...
func ExampleScanProject() {
	mapFS := fstest.MapFS{
		...
		exampleMainGo: &fstest.MapFile{Data: []byte("package main\nfunc main() {}\n")},
	}
