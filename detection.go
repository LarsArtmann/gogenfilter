...
// contentCheck associates a filter option with its reason and content-based detection function.
// Ordered from most specific to least specific; FilterGeneric must be last.
var contentChecks = []struct {
	option FilterOption
	reason FilterReason
...
// filenameCheck associates a filter option with its reason and filename-based detection function.
// Ordered from most specific to least specific.
var filenameChecks = []struct {
	option FilterOption
	reason FilterReason
	match  func(string) bool
}{
	{FilterSQLC, ReasonSQLC, matchesSQLCFilenamePattern},
	{FilterTempl, ReasonTempl, func(f string) bool { return strings.HasSuffix(f, "_templ.go") }},
	{FilterGoEnum, ReasonGoEnum, func(f string) bool { return strings.HasSuffix(f, "_enum.go") }},
...
// sqlcCodePatterns contains code patterns specific to sqlc-generated files.
