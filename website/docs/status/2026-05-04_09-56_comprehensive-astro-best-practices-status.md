...
- [x] 14+ custom color tokens (bg-primary, bg-card, border, text-*, accent*, amber, code-*, success)
...
| 5 | Audit remaining hardcoded colors (stone-*, green-*) | Consistency | 10min | Design |
