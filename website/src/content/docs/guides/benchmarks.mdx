...
Benchmarked on Go 1.24, AMD Ryzen AI MAX+ 395. Results may vary by hardware.
...
### Filename Detection (Phase 1)

Zero-I/O filename matching. No file reads, no content parsing.

```
DetectGenerated    14 ns/op    0 B/op    0 allocs/op
```

This is the fast path — a single scan of the filename against the detector table.

### Per-Generator Checks

Individual `Is*Generated` functions combining filename and content checks:
